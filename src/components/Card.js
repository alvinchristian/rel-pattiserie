...
const Card = ({ photo, name, price }) => {
	...
	return (
		<div className="bg-white rounded-xl p-4 m-2 w-full sm:w-32 md:w-36 lg:w-40 flex sm:flex-col justify-start sm:justify-center items-center space-x-4 sm:space-x-0 space-y-1">
